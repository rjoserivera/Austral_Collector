    ...
    <div className="contacto-page">
      ...
      <div className="section-wrapper contacto-inner-narrow">
        ...
        <header className="contacto-hero-row">
          <img src="/mascota_sin_fondo.png" alt="Austral Collector Robot" className="contacto-hero-robot"/>
        ...
        <aside className="contacto-panel card-distressed-sub">
          ...
          <div className="social-footer">
            ...
            <div className="social-icons-real">
              ...
              <a href="#tw" className="real-soc tw" aria-label="Twitter">
              ...
              <a href="#ig" className="real-soc ig" aria-label="Instagram">
              ...
              <a href="#yt" className="real-soc yt" aria-label="YouTube">
