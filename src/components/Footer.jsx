      ...
      <div className="footer-inner section-wrapper">
        ...
        <div className="footer-social-col" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          <div className="footer-social-group" style={{ justifyContent: 'center' }}>
            <a href="https://www.instagram.com/australcollector/" target="_blank" rel="noopener noreferrer" className="social-item social-ig">
              <span className="social-icon-box">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
              </span>
              <span className="social-label">Instagram</span>
            </a>
            <a href="https://www.facebook.com/profile.php?id=61573729671622" target="_blank" rel="noopener noreferrer" className="social-item social-fb">
              <span className="social-icon-box">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path></svg>
              </span>
              <span className="social-label">Facebook</span>
            </a>
            <a href="https://www.youtube.com/@AUSTRALCOLLECTOR" target="_blank" rel="noopener noreferrer" className="social-item social-yt">
              <span className="social-icon-box">
