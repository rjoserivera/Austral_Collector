    ...
    <html><head><style>
        ...
        <div class='container'>
            <div class='header-logo'>
                <a href='https://austral-collector.cl' target='_blank'>
                    <img src='https://austral-collector.cl/logo_sin_fondo2.png' alt='Austral Collector Logo' width='150' style='display:block;margin:0 auto;border:0;' />
                </a>
            </div>
            ...
            <div class='footer'>
                Equipo de Administración de <a href='https://austral-collector.cl' target='_blank'>Austral Collector</a>
            </div>
        </div>
    </body></html>
HTML;
...
function sendTempKeyEmail($toEmail, $username, $tempKey) {
    ...
    <html><head><style>
        ...
        <div class='container'>
            ...
            <div class='header'>Hola, {$username}</div>
            <p>Se ha generado una clave temporal para tu cuenta en <a href='https://austral-collector.cl' target='_blank' style='color:#1e4d5a;font-weight:bold;text-decoration:none;'>Austral Collector</a>.</p>
            ...
            <div class='footer'>Mensaje automático del sistema — Administración <a href='https://austral-collector.cl' target='_blank'>Austral Collector</a>.</div>
        </div>
    </body></html>
HTML;
...
function sendCustomEmail($toEmail, $username, $subject, $messageText) {
    ...
    <html><head><style>
        ...
        <div class='container'>
            ...
            <div class='footer'>Enviado por la administración de <a href='https://austral-collector.cl' target='_blank'>Austral Collector</a>.</div>
        </div>
    </body></html>
HTML;
